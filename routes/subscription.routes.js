...
import {createSubscription, getUsrSubscriptions} from '../controllers/subscription.controller.js'
...
subscriptionRouter.get('/user/:id',authorized,getUsrSubscriptions);
